...
.. note::
	...
	**Perhatikan:** Sebelum melanjutkan, pastikan program **Lexique Pro** sudah terinstal di mesin yang akan mengekspor kamus.
...
#. Tekan tombol ``Ctrl + H`` untuk membuka jendela dialog **Find & Replace**.
...
#. Tekan tombol ``Ctrl + A`` untuk menyorot semua teks dalam dokumen
